 ...
 * @link    https://matomo.org
 * @license https://www.gnu.org/licenses/gpl-3.0.html GPL v3 or later
 */function _a(e){const t=[...e||[]];return t.sort((e,t)=>e.order<t.order?-1:e.order>t.order?1:0),t}
/*!
 * Matomo - free/libre analytics platform
 *
 * @link    https://matomo.org
 ...
 * @link    https://matomo.org
 * @license https://www.gnu.org/licenses/gpl-3.0.html GPL v3 or later
 */const kc={class:Object(E["normalizeClass"])({modal:!0,"entity-duplicator-modal":!0,"slot-configured":!0}),ref:"root"},Sc={class:"main-duplicator-modal-content"},Cc={class:"modal-header"},Ec=Object(E["createElementVNode"])("span",{class:"btn-close modal-close"},[Object(E["createElementVNode"])("i",{class:"icon-close"})],-1),Dc={key:0,class:"modal-sub-header"},Pc={class:"loading-message"},Tc={class:"modal-sub-header"},Vc=["innerHTML"],Nc={class:"modal-content"},xc={class:"modal-inputs"},Bc={class:"modal-sub-footer"},Ic=["innerHTML"],Mc=["innerHTML"],Lc={class:"modal-footer"},Fc=["disabled"];function _c(e,t,o,i,n,a){const r=Object(E["resolveComponent"])("MatomoLoader"),s=Object(E["resolveDirective"])("form");return Object(E["openBlock"])(),Object(E["createElementBlock"])("div",kc,[Object(E["withDirectives"])(Object(E["createElementVNode"])("div",Sc,[Object(E["createElementVNode"])("div",Cc,[Ec,Object(E["createElementVNode"])("h2",null,Object(E["toDisplayString"])(e.getModalTitle),1)]),e.isLoading?(Object(E["openBlock"])(),Object(E["createElementBlock"])("div",Dc,[Object(E["createVNode"])(r),Object(E["createElementVNode"])("span",Pc,Object(E["toDisplayString"])(e.translate("General_Loading")),1)])):(Object(E["openBlock"])(),Object(E["createElementBlock"])(E["Fragment"],{key:1},[Object(E["createElementVNode"])("div",Tc,[Object(E["createElementVNode"])("p",null,[Object(E["createTextVNode"])(Object(E["toDisplayString"])(e.getDuplicateDescription)+" ",1),e.descriptionLearnMoreLink?(Object(E["openBlock"])(),Object(E["createElementBlock"])("span",{key:0,innerHTML:e.$sanitize(e.getLearnMoreLink)},null,8,Vc)):Object(E["createCommentVNode"])("",!0)])]),Object(E["createElementVNode"])("div",Nc,[Object(E["withDirectives"])((Object(E["openBlock"])(),Object(E["createElementBlock"])("div",xc,[Object(E["renderSlot"])(e.$slots,"default")])),[[s]])]),Object(E["createElementVNode"])("div",Bc,[e.duplicationErrors.length>0?(Object(E["openBlock"])(),Object(E["createElementBlock"])("div",{key:0,class:Object(E["normalizeClass"])({alert:!0,"alert-danger":!0,"error-list":e.duplicationErrors.length>1})},[Object(E["createElementVNode"])("ul",null,[(Object(E["openBlock"])(!0),Object(E["createElementBlock"])(E["Fragment"],null,Object(E["renderList"])(e.duplicationErrors,(t,o)=>(Object(E["openBlock"])(),Object(E["createElementBlock"])("li",{key:o,innerHTML:e.$sanitize(t)},null,8,Ic))),128))])],2)):Object(E["createCommentVNode"])("",!0),Object(E["createElementVNode"])("p",{class:"note-text",innerHTML:e.$sanitize(e.getNoteText)},null,8,Mc)]),Object(E["createElementVNode"])("div",Lc,[Object(E["createElementVNode"])("button",{class:"btn",disabled:!e.getIsValid||e.hasBeenSubmitted,onClick:t[0]||(t[0]=t=>e.submitRequest())},Object(E["toDisplayString"])(e.translate("General_Copy")),9,Fc)])],64))],512),[[E["vShow"],e.isModalVisible]])],512)}const Ac=be("CorePluginsAdmin","Form"),{$:Rc}=window;var Hc=Object(E["defineComponent"])({directives:{Form:Ac},components:{MatomoLoader:Me},props:{modalStore:{type:Object,required:!0},adapter:{type:Object,required:!0},descriptionLearnMoreLink:{type:String,default:""}},data(){return{isLoading:!0,isValidated:!1,duplicationErrors:[],hasBeenSubmitted:!1}},emits:["duplicationSuccessful","duplicationFailed"],watch:{isModalVisible(e){e&&(this.showModal(),this.isLoading=!1)}},methods:{closeModal(){const e=this.$refs.root,t=Rc(e);t.modal("close")},resetModal(){this.modalStore.hideModal(),this.isLoading=!0,this.isValidated=!1,this.duplicationErrors=[],this.hasBeenSubmitted=!1},showModal(){const e=this.$refs.root,t=Rc(e);t.modal({dismissible:!0,onCloseEnd:()=>{this.resetModal()}}).modal("open")},submitRequest(){if(this.hasBeenSubmitted=!0,this.modalStore.disableWatchSuppression(),this.validateFormFields(),!this.getIsValid)return void(this.hasBeenSubmitted=!1);const e=this.adapter.prepareApiParams(this.modalStore.state.entityFormData);this.adapter.submitRequest(e).then(e=>{e&&e.isDuplicationSuccessful?(this.adapter.onSuccess&&this.adapter.onSuccess(e),this.$emit("duplicationSuccessful",e),this.closeModal()):this.emitFailureAndSetErrorMessage(e)}).catch(e=>{this.emitFailureAndSetErrorMessage(),this.adapter.onFailure&&this.adapter.onFailure(e),console.log("Unexpected server error during request.",e)}).finally(()=>{this.hasBeenSubmitted=!1})},validateFormFields(){if(this.isValidated=!0,this.duplicationErrors=[],!this.modalStore.state.isModalVisible)return;const e=this.adapter.validateFormFields(this.modalStore.state.entityFormData);!e.isValid&&e.errorMessages.length>0&&(this.duplicationErrors=e.errorMessages)},emitFailureAndSetErrorMessage(e=null){let t=e;t||(t={isDuplicationSuccessful:!1,errorMessage:a("General_ErrorRequest","","")}),t.errorMessage&&0!==t.errorMessage.length||(t.errorMessage=a("General_ErrorRequest","","")),this.duplicationErrors=[],this.duplicationErrors.push(t.errorMessage),this.$emit("duplicationFailed",t)}},mounted(){Object(E["watch"])(()=>this.modalStore.state.entityFormData,()=>{this.modalStore.state.isWatchSuppressed||(this.isValidated=!1)},{deep:!0})},computed:{isModalVisible(){var e;return null!==(e=this.modalStore.state.isModalVisible)&&void 0!==e&&e},getModalTitle(){return a("CoreHome_CopyX",this.modalStore.getEntityTypeTranslation)},getNoteText(){const e=a("CoreHome_CopyModalNote","<strong>","</strong>",this.modalStore.getEntityTypeTranslation);return""+e},getDuplicateDescription(){return a("CoreHome_CopyXDescription",this.modalStore.getEntityTypeTranslation)},getLearnMoreLink(){if(!this.descriptionLearnMoreLink)return"";const e=ne(this.descriptionLearnMoreLink);return a("CoreHome_LearnMoreFullStop",e,"</a>")},getIsValid(){return!this.isValidated||Array.isArray(this.duplicationErrors)&&0===this.duplicationErrors.length}}});Hc.render=_c;var $c=Hc;const Uc=["title","aria-disabled"];function qc(e,t,o,i,n,a){const r=Object(E["resolveDirective"])("tooltips");return Object(E["withDirectives"])((Object(E["openBlock"])(),Object(E["createElementBlock"])("a",{class:Object(E["normalizeClass"])([{"entity-duplicator-action":!0,"table-action":!0,"icon-content-copy":!0,"is-disabled":!e.isActionEnabled},e.extraClasses]),title:e.getActionTooltip,"aria-disabled":!e.isActionEnabled,onClick:t[0]||(t[0]=t=>!e.isActionEnabled||e.handleClick())},null,10,Uc)),[[r],[E["vShow"],e.isActionVisible]])}var Wc=Object(E["defineComponent"])({props:{actionFormData:{type:Object,required:!0},modalStore:{type:Object,required:!0},isActionVisible:{type:Boolean,required:!0},isActionEnabled:{type:Boolean,default:!1},tooltipTextOverride:{type:String,default:""},tooltipTextOverrideDisabled:{type:String,default:""},extraClasses:{type:[String,Array,Object],default:""}},directives:{Tooltips:Ze},methods:{handleClick(){this.modalStore.showModal(this.actionFormData)}},computed:{getActionTooltip(){return this.isActionEnabled&&this.tooltipTextOverride.length?r(this.tooltipTextOverride):!this.isActionEnabled&&this.tooltipTextOverrideDisabled.length?r(this.tooltipTextOverrideDisabled):a("CoreHome_CopyX",this.modalStore.getEntityTypeTranslation)}}});Wc.render=qc;var zc=Wc;function Gc(e,t,o){return t in e?Object.defineProperty(e,t,{value:o,enumerable:!0,configurable:!0,writable:!0}):e[t]=o,e}
/*!
 * Matomo - free/libre analytics platform
 *
 * @link    https://matomo.org
 * @license https://www.gnu.org/licenses/gpl-3.0.html GPL v3 or later
 */class Yc{constructor(e,t,o){Gc(this,"state",Object(E["reactive"])({isModalVisible:!1,isWatchSuppressed:!1,commonFormData:{},entityFormData:{},duplicateEntityType:"",duplicateEntityTypeTranslation:""})),this.state.duplicateEntityType=e,this.state.duplicateEntityTypeTranslation=t,this.state.commonFormData=null!==o&&void 0!==o?o:{}}showModal(e){this.resetFormData(),Object.entries(null!==e&&void 0!==e?e:{}).forEach(([e,t])=>{this.state.entityFormData[e]=t}),this.state.isModalVisible=!0}hideModal(){this.state.isModalVisible=!1,this.resetFormData()}resetFormData(){this.state.isWatchSuppressed=!0,Object.keys(this.state.entityFormData).forEach(e=>{delete this.state.entityFormData[e]})}disableWatchSuppression(){this.state.isWatchSuppressed=!1}get getEntityTypeTranslation(){let e="CoreHome_ReportLowercase";return this.state.duplicateEntityTypeTranslation&&(e=this.state.duplicateEntityTypeTranslation),r(e)}}function Jc(e,t,o){return Object(E["reactive"])(new Yc(e,t,o))}
/*!
 * Matomo - free/libre analytics platform
 *
 * @link    https://matomo.org
